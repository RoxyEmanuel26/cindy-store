...
export const metadata = generatePageMetadata({
    title: 'Beranda',
    description: 'Selamat datang di Cindy Lay! Temukan koleksi aksesori wanita colorful: gantungan kunci lucu, beads bracelet, beads HP, kalung, dan anting. Tersedia di Shopee dan Tokopedia.',
    path: '/',
})
...
export default async function HomePage() {
    ...
    return (
        <>
            ...
            {/* === SECTION 7: WHY CINDY LAY === */}
            <section className="py-16 bg-brand-primary/5 dark:bg-dark-surface">
                <div className="container mx-auto px-4 text-center">
                    <FadeIn>
                        <h2 className="text-3xl font-bold text-brand-text dark:text-dark-text mb-4">Kenapa Pilih Cindy Lay?</h2>
                    </FadeIn>
            ...
            <section className="py-16 bg-brand-primary dark:bg-dark-primary">
                <div className="container mx-auto px-4 text-center text-white">
                    <FadeIn>
                        ...
                        <a href={`https://wa.me/${settings.wa_number}?text=${encodeURIComponent('Halo Cindy Lay!')}`} target="_blank" rel="noopener noreferrer">
