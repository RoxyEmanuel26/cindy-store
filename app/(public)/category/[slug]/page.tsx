...
export async function generateMetadata({ params }: PageProps) {
    ...
    if (!category) return { title: 'Kategori Tidak Ditemukan - Cindy Lay' }
    return generatePageMetadata({
        title: category.name,
        description: `Koleksi produk kategori ${category.name} dari Cindy Lay. Temukan aksesori favoritmu sekarang!`,
        path: `/category/${slug}`,
    })
}
