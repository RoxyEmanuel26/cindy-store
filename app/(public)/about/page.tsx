...
export const metadata = generatePageMetadata({
    title: 'Tentang Kami',
    description: 'Kenali lebih dekat Cindy Lay, toko aksesori wanita favorit yang memproduksi produk handmade dengan penuh cinta.',
    path: '/about',
})
            ...
            <section className="py-16 bg-white dark:bg-dark-bg">
                <div className="container mx-auto px-4 max-w-3xl">
                    <div className="prose dark:prose-invert prose-brand max-w-none text-brand-text dark:text-dark-text leading-relaxed whitespace-pre-wrap">
                        {settings.about_text || 'Cindy Lay adalah toko aksesori wanita yang menyajikan koleksi produk handmade berkualitas tinggi.'}
                    </div>
                </div>
            </section>
