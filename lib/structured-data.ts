const BASE_URL = process.env.NEXTAUTH_URL || 'https://cindylay.com'
...
export function getProductSchema(product: {
    ...
    return {
        ...
        brand: { '@type': 'Brand', name: 'Cindy Lay' },
        offers: [
            {
                '@type': 'Offer',
                price: product.price,
                ...
                seller: { '@type': 'Organization', name: 'Cindy Lay di Shopee' },
            },
            {
                '@type': 'Offer',
                price: product.price,
                ...
                seller: { '@type': 'Organization', name: 'Cindy Lay di Tokopedia' },
            },
        ],
    }
}
