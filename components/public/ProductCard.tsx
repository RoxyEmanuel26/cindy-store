    ...
    return (
        <Link href={`/products/${product.slug}`}>
            <motion.div
                ...
                className="group relative bg-white dark:bg-dark-surface rounded-2xl overflow-hidden shadow-sm cursor-pointer"
            >
                {/* Image */}
                ...
                {/* Info */}
                <div className="p-3">
                    <span className="text-xs text-brand-primary dark:text-dark-primary font-medium">
                        {product.category?.name}
                    </span>

                    <h3 className="font-semibold text-sm mt-1 text-brand-text dark:text-dark-text line-clamp-2 leading-tight">
                        {product.title}
                    </h3>
